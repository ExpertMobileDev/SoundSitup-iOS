...
@synthesize lcvoiceDelegate = _lcvoiceDelegate;
...
- (void)updateMeters {
    ...
    */
    ...
    [self.lcvoiceDelegate updatePWMeter:peakPower count:self.recordTime/WAVE_UPDATE_FREQUENCY];
    
    if (self.recordTime > 10 && _isRecording == YES)
    {
        _isRecording = NO;
        [_recorder stop];
